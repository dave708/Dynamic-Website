...
<main>
<a href='addproperty.php?propertyid=$propertyid'>Add a new property</a>
<p>
...
echo "<p><a href='editproperty.php?propertyid=$propertyid'>Edit</a></p>";
echo "<p><a href='confirmdeleteproperty.php?propertyid=$propertyid'>Delete</a></p>";
